...
func NewAuthService(repo repository.AuthRespository, logger *slog.Logger, hasher bcryptx.HashService) *Service {
	return &Service{repo: repo, logger: logger, hasher: hasher}
}
